...
::: {.g-col-8}
This metrics report shows data for encounter information for **Brooke Johannes**. 
Brooke's start and end date with EIP are shown below, however, any data contained 
...
::: {.g-col-4 .text-center}
![](images/b_johannes.jpg){width="20em" .rounded}
:::
:::
