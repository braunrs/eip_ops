...
enc$no_service[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
enc$approach_assessment[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
# Declined
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_declined[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
# Prevented
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_prevented[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
                            enc$offer_outcome_risks == 2] <- 1
...
# Assessed
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
table(enc$ctr_calc)
enc$ctr_tests[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) & enc$ctr_calc == 1] <- 1
...
table(enc$ehe_calc)
enc$ehe_tests[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) & enc$ehe_calc == 1] <- 1
...
enc$hiv_false_positive[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
enc$hiv_indeterminate[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
enc$hcv_rapid_test[(enc$counselor_risk_start == 'zpowck6v' | enc$enc_counselor == 81) &
...
::: {.g-col-8}
This metrics report shows data for encounter information for **Connor Powers**. The metrics in this report describe specific encounter information and the services and/or referrals that were provided to patients/clients.
...
::: {.g-col-4 .text-center}
![](images/c_powers2.jpg){width="20em" .rounded}
:::
:::
