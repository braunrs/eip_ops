...
### EIP Database Data
# 2023
eip23 <- read.csv('M:/EIP Data/EIP Database/REDCap 2023/EIP Database Data 20260330_1111.csv')
dim(eip23)
...
# 2024
eip24 <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20260330_1253.csv')
dim(eip24)
...
# 2025
eip25 <- read.csv('M:/EIP Data/EIP Database/REDCap 2025/EIP Database Data 20260602_0845.csv')
dim(eip25)
...
# 2026
eip26 <- read.csv('M:/EIP Data/EIP Database/REDCap 2026/EIP Database Data 20260623_0834.csv')
dim(eip26)
...
eip23$mgen_sr <- ''
eip23$mgen_treat <- ''
eip23$pitula_ltc_open_calc <- ''
eip23$ltc_coordinator_per_case___93 <- ''
eip23$ltc_coordinator_per_case___94 <- ''
eip23$ltc_coordinator_per_case___95 <- ''
eip23$ltc_coordinator_per_case___96 <- ''
...
eip24$mgen_sr <- ''
eip24$mgen_treat <- ''
eip24$pitula_ltc_open_calc <- ''
eip24$ltc_coordinator_per_case___93 <- ''
eip24$ltc_coordinator_per_case___94 <- ''
eip24$ltc_coordinator_per_case___95 <- ''
eip24$ltc_coordinator_per_case___96 <- ''
...
eip25$mgen_sr <- ''
eip25$mgen_treat <- ''
eip25$pitula_ltc_open_calc <- ''
eip25$ltc_coordinator_per_case___93 <- ''
eip25$ltc_coordinator_per_case___94 <- ''
eip25$ltc_coordinator_per_case___95 <- ''
eip25$ltc_coordinator_per_case___96 <- ''
...
enc$no_service[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
                 (is.na(enc$offer_outcome_risks) | enc$offer_outcome_risks == '') &
...
enc$approach_assessment[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
...
# Declined
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_declined[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
...
# Prevented
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_prevented[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
                            enc$offer_outcome_risks == 2] <- 1
...
# Assessed
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
...
table(enc$ctr_calc)
enc$ctr_tests[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) & enc$ctr_calc == 1] <- 1
...
table(enc$ehe_calc)
enc$ehe_tests[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) & enc$ehe_calc == 1] <- 1
ehe_tests <- enc[which(enc$ehe_tests == 1), ]
...
enc$hiv_false_positive[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
...
enc$hiv_indeterminate[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
                        enc$final_test_status_hiv == 2] <- 1
...
enc$hcv_rapid_test[(enc$counselor_risk_start == 'zkomrlf0' | enc$enc_counselor == 27) &
...
::: {.g-col-8}
This metrics report shows data for encounter information for **Rachel Kombo**. The metrics in this report describe specific encounter information and the services and/or referrals that were provided to patients/clients.
...
::: {.g-col-4 .text-center}
![](images/r_kombo2.jpg){width="20em" .rounded}
:::
:::
