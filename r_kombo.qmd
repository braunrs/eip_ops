...
::: {.g-col-8}
This metrics report shows data for encounter information for **Rachel Kombo**. 
Rachel's start and end date with EIP are shown below, however, any data contained 
