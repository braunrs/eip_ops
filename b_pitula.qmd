...
eip$Pitula[eip$counselor_enc_start == 'zpitbb5a' |
              eip$counselor_risk_start == 'zpitbb5a' |
              eip$counselor_hiv_start == 'zpitbb5a' |
              eip$counselor_hcv_start == 'zpitbb5a' |
              eip$enc_counselor == 82 |
              eip$ltc_coord_start == 'zpitbb5a' |
              eip$ltc_coordinator_per_case___82 == 1] <- 1
table(eip$Pitula)
...
monthly_encounters <- select(enc, enc_date, Pitula)
monthly_encounters <- monthly_encounters[which(monthly_encounters$Pitula == 1), ]
...
enc$approach_assessment[(enc$counselor_risk_start == 'zpitbb5a') &
...
# Declined
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_declined[(enc$counselor_risk_start == 'zpitbb5a') &
...
# Prevented
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_prevented[(enc$counselor_risk_start == 'zpitbb5a') &
                            enc$offer_outcome_risks == 2] <- 1
...
# Assessed
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments[(enc$counselor_risk_start == 'zpitbb5a') &
...
table(enc$ctr_calc)
enc$ctr_tests[enc$ctr_calc == 1 & enc$counselor_hiv_start == 'zpitbb5a'] <- 1
...
table(enc$ehe_calc)
enc$ehe_tests[enc$ehe_calc == 1 & enc$counselor_hiv_start == 'zpitbb5a'] <- 1
ehe_tests <- enc[which(enc$ehe_calc == 1 & enc$counselor_hiv_start == 'zpitbb5a'), ]
...
enc$hiv_false_positive[enc$counselor_hiv_start == 'zpitbb5a' &
...
enc$hiv_indeterminate[enc$counselor_hiv_start == 'zpitbb5a' & enc$final_test_status_hiv == 2] <- 1
...
enc$hcv_rapid_test[enc$counselor_hcv_start == 'zpitbb5a' &
...
enc$ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$hiv_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$hcv_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$sud_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$ht_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$mh_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$housing_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$prep_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$sti_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$food_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$financial_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$personabuse_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$general_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
enc$other_ltc_cases[enc$ltc_coordinator_per_case___82 == 1 &
...
metrics_plot <- metrics_plot %>%
  layout(title = 'Pitula Monthly Encounters & Services',
...
assessment_plot <- assessment_plot %>%
  layout(title = 'Pitula Monthly Assessment Trends',
         #xaxis = list(rangeslider = list(type = "date")),
         yaxis = list(title = "Total")) %>%
  config(displayModeBar = FALSE)
assessment_plot
...
monthly_hiv_testing_plot <- plot_ly(data = monthly_hiv_tests, x = ~Date, y = ~ctr_tests, type = 'bar', name = 'CTR Tests',
  ...
  layout(title = 'Pitula Monthly Rapid HIV Testing',
         #xaxis = list(rangeslider = list(type = "date")),
...
monthly_hcv_testing_plot <- plot_ly(data = monthly_hcv_tests, x = ~Date, y = ~hcv_tests, type = 'bar', name = 'HCV Tests',
  ...
  layout(title = 'Pitula Monthly Hepatitis C Testing',
         #xaxis = list(rangeslider = list(type = "date")),
