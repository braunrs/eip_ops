...
eip$Anderson[eip$counselor_enc_start == 'zandk5le' |
              eip$counselor_risk_start == 'zandk5le' |
              eip$counselor_hiv_start == 'zandk5le' |
              eip$counselor_hcv_start == 'zandk5le' |
              eip$enc_counselor == 70 |
              eip$ltc_coord_start == 'zandk5le' |
              eip$ltc_coordinator_per_case___70 == 1] <- 1
table(eip$Anderson)
...
monthly_encounters <- select(enc, enc_date, Anderson)
monthly_encounters <- monthly_encounters[which(monthly_encounters$Anderson == 1), ]
...
enc$approach_assessment[(enc$counselor_risk_start == 'zandk5le') &
...
# Declined
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_declined[(enc$counselor_risk_start == 'zandk5le') &
...
# Prevented
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_prevented[(enc$counselor_risk_start == 'zandk5le') &
                            enc$offer_outcome_risks == 2] <- 1
...
# Assessed
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments[(enc$counselor_risk_start == 'zandk5le') &
...
table(enc$ctr_calc)
enc$ctr_tests[enc$ctr_calc == 1 & enc$counselor_hiv_start == 'zandk5le'] <- 1
...
table(enc$ehe_calc)
enc$ehe_tests[enc$ehe_calc == 1 & enc$counselor_hiv_start == 'zandk5le'] <- 1
ehe_tests <- enc[which(enc$ehe_calc == 1 & enc$counselor_hiv_start == 'zandk5le'), ]
...
enc$hiv_false_positive[enc$counselor_hiv_start == 'zandk5le' &
...
enc$hiv_indeterminate[enc$counselor_hiv_start == 'zandk5le' & enc$final_test_status_hiv == 2] <- 1
...
enc$hcv_rapid_test[enc$counselor_hcv_start == 'zandk5le' &
...
enc$ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$hiv_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$hcv_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$sud_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$ht_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$mh_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$housing_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$prep_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$sti_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$food_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$financial_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$personabuse_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$general_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
enc$other_ltc_cases[enc$ltc_coordinator_per_case___70 == 1 &
...
metrics_plot <- metrics_plot %>%
  layout(title = 'Anderson Monthly Encounters & Services',
...
assessment_plot <- assessment_plot %>%
  layout(title = 'Anderson Monthly Assessment Trends',
         #xaxis = list(rangeslider = list(type = "date")),
         yaxis = list(title = "Total")) %>%
  config(displayModeBar = FALSE)
assessment_plot
...
monthly_hiv_testing_plot <- plot_ly(data = monthly_hiv_tests, x = ~Date, y = ~ctr_tests, type = 'bar', name = 'CTR Tests',
  ...
  layout(title = 'Anderson Monthly Rapid HIV Testing',
         #xaxis = list(rangeslider = list(type = "date")),
...
monthly_hcv_testing_plot <- plot_ly(data = monthly_hcv_tests, x = ~Date, y = ~hcv_tests, type = 'bar', name = 'HCV Tests',
  ...
  layout(title = 'Anderson Monthly Hepatitis C Testing',
         #xaxis = list(rangeslider = list(type = "date")),
