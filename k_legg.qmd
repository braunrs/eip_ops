...
eip$Legg[eip$counselor_enc_start == 'zlegku7f' |
              ...
              eip$ltc_coordinator_per_case___68 == 1 |
           eip$peer_navigator == 1] <- 1
table(eip$Legg)
...
enc$no_service[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
enc$approach_assessment[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
# Declined
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_declined[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
# Prevented
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_prevented[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
                            enc$offer_outcome_risks == 2] <- 1
...
# Assessed
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
table(enc$ctr_calc)
enc$ctr_tests[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) & enc$ctr_calc == 1] <- 1
...
table(enc$ehe_calc)
enc$ehe_tests[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) & enc$ehe_calc == 1] <- 1
...
enc$hiv_false_positive[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
enc$hiv_indeterminate[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
enc$hcv_rapid_test[(enc$counselor_risk_start == 'zlegku7f' | enc$enc_counselor == 68) &
...
::: {.g-col-8}
This metrics report shows data for encounter information for **Kathy Legg**. The metrics in this report describe specific encounter information and the services and/or referrals that were provided to patients/clients.
...
::: {.g-col-4 .text-center}
![](images/k_legg.jpg){width="20em" .rounded}
:::
:::
