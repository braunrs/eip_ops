...
# 2024
eip24 <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20240422_0820.csv')
dim(eip24)
...
enc$assessments[enc$offer_outcome_risks == 1 & (enc$counselor_risk_start == 'zmaicq7y' | enc$enc_counselor == 79)] <- 1
...
table(enc$ctr_calc)
enc$ctr_tests[enc$ctr_calc == 1 & (enc$counselor_hiv_start == 'zmaicq7y' | enc$enc_counselor == 79)] <- 1
...
enc$hcv_rapid_test[(enc$sample_type_hcv1 == 5 |
                      ...
                      enc$sample_type_hcv6 == 5) & (enc$counselor_hcv_start == 'zmaicq7y' | enc$enc_counselor == 79)] <- 1
