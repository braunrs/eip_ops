...
### EIP Database Data
# 2023
eip23 <- read.csv('M:/EIP Data/EIP Database/REDCap 2023/EIP Database Data 20250112_1508.csv')
dim(eip23)
...
# 2024
eip24 <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20250112_1511.csv')
dim(eip24)
...
# 2025
eip25 <- read.csv('M:/EIP Data/EIP Database/REDCap 2025/EIP Database Data 20250113_1015.csv')
dim(eip25)
...
# until all 2024 encounters are removed from 2025 database...
summary(eip25$enc_date)
eip25$enc_date <- as.Date(eip25$enc_date, format = '%m/%d/%Y')
summary(eip25$enc_date)
eip25 <- eip25[which(eip25$enc_date >= '2025-01-01'), ]
summary(eip25$enc_date)
...
names(eip23)[names(eip23) == 'unsafe_work'] <- 'raft1'
names(eip23)[names(eip23) == 'forced_work'] <- 'raft2'
names(eip23)[names(eip23) == 'fear_leave_work'] <- 'raft3'
names(eip23)[names(eip23) == 'exchange_for_sex'] <- 'raft4'
...
# Changing 2024 variable names that were changed in 2025 dataset
names(eip24)[names(eip24) == 'unsafe_work'] <- 'raft1'
names(eip24)[names(eip24) == 'forced_work'] <- 'raft2'
names(eip24)[names(eip24) == 'fear_leave_work'] <- 'raft3'
names(eip24)[names(eip24) == 'exchange_for_sex'] <- 'raft4'
