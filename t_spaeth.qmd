...
# 2024
eip24 <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20241209_1427.csv')
dim(eip24)
...
enc$approach_assessment[(enc$counselor_risk_start == 'zspat2nf') &
...
# Declined
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_declined[(enc$counselor_risk_start == 'zspat2nf') &
...
# Prevented
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments_prevented[(enc$counselor_risk_start == 'zspat2nf') &
                            enc$offer_outcome_risks == 2] <- 1
...
# Assessed
table(enc$counselor_risk_start, enc$offer_outcome_risks)
enc$assessments[(enc$counselor_risk_start == 'zspat2nf') &
...
table(enc$ctr_calc)
enc$ctr_tests[enc$ctr_calc == 1 & enc$counselor_hiv_start == 'zspat2nf'] <- 1
...
table(enc$ehe_calc)
enc$ehe_tests[enc$ehe_calc == 1 & enc$counselor_hiv_start == 'zspat2nf'] <- 1
ehe_tests <- enc[which(enc$ehe_calc == 1 & enc$counselor_hiv_start == 'zspat2nf'), ]
...
enc$hiv_false_positive[enc$counselor_hiv_start == 'zspat2nf' &
...
enc$hiv_indeterminate[enc$counselor_hiv_start == 'zspat2nf' & enc$final_test_status_hiv == 2] <- 1
...
enc$hcv_rapid_test[enc$counselor_hcv_start == 'zspat2nf' &
...
enc$ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$hiv_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$hcv_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$sud_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$ht_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$mh_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$housing_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$prep_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$sti_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$food_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$financial_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$personabuse_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$general_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
...
enc$other_ltc_cases[enc$ltc_coordinator_per_case___77 == 1 &
