...
::: {.g-col-8}
This metrics report shows data for encounter information for **Timothy Spaeth**. 
Timothy's start and end date with EIP are shown below, however, any data contained 
