...
enc$assessments[enc$offer_outcome_risks == 1 & (enc$counselor_risk_start == 'zsalae6w' | enc$enc_counselor == 66)] <- 1
...
table(enc$ctr_calc)
enc$ctr_tests[enc$ctr_calc == 1 & (enc$counselor_hiv_start == 'zsalae6w' | enc$enc_counselor == 66)] <- 1
...
enc$hcv_rapid_test[(enc$sample_type_hcv1 == 5 |
                      ...
                      enc$sample_type_hcv6 == 5) & (enc$counselor_hcv_start == 'zsalae6w' | enc$enc_counselor == 66)] <- 1
