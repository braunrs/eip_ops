...
::: {.g-col-8}
This metrics report shows data for encounter information for **Noah McGorry**. 
Noah's start and end date with EIP are shown below, however, any data contained 
